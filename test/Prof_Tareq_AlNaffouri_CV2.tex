...
%
%\item Mérouane Debbah, Professor, Electrical Engineering Department,
%{\em Ecole Supérieure d'Electricité (Supélec),} Paris, France
%
%
...
\item ï¿½Blind channel estimation of OFDM system by relying on the Gaussian assumption of the input,ï¿½ {\em funded by Deanship of Scientific Research, King Fahd University of Petroleum \& Minerals,} Mar. 2009 -- May 2010. (Principal Investigator)
...
downlink channels?" {\em Institute Eurï¿½com, Sophia-Antipolis,}
France, Jun. 21, 2007.
...
\item ``How much does correlation affect the sum-rate of MIMO
downlink channels?ï¿½ {\em Electrical Engineering Department,
