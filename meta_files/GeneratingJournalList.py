        ...
        for item_key0 in sorted_keys:
            ...
            if publication_data[item_key]['status'].lower() == 'published':
                full_entry = '\item ' + author_names + \
                             ...
                             ', Vol.' + publication_data[item_key].get('volume', '') + \
                             ', pp.' + publication_data[item_key]['pages'] + \
...
def main():
    journal_bib_name = "JournalPublications V5.bib"
    ...
    conference_bib_name = "ConferencePublications V4.bib"
